                ...
                <nav className="hidden lg:flex items-center gap-8">
                    {navItems.map((item) => (
                        <Link
                            key={item.label}
                            href={item.href}
                            className="text-md font-medium text-black hover:text-darkkhaki transition-colors relative py-1.5 after:absolute after:bottom-0 after:left-0 after:h-0.5 after:w-0 after:bg-darkkhaki after:transition-all hover:after:w-full"
                        >
                            {item.label}
                        </Link>
                    ))}
